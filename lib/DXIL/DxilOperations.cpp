...
const OP::OpCodeProperty OP::m_OpCodeProps[(unsigned)OP::OpCode::NumOpCodes] = {
    ...
    // CoopVector void,     h,     f,     d,    i1,    i8,   i16,   i32,   i64,
    // udt,   obj ,  function attribute
    {
        OC::CoopVector_Index,
        "CoopVector_Index",
        OCC::CoopVector_Index,
        "coopVector_Index",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::ReadOnly,
    ...
    {
        OC::CoopVector_Annotate,
        "CoopVector_Annotate",
        OCC::CoopVector_Annotate,
        "coopVector_Annotate",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::ArgMemOnly,
    ...
    {
        OC::CoopVector_ScalarOp,
        "CoopVector_ScalarOp",
        OCC::CoopVector_ScalarOp,
        "coopVector_ScalarOp",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    ...
    {
        OC::CoopVector_ArithmeticOp,
        "CoopVector_ArithmeticOp",
        OCC::CoopVector_ArithmeticOp,
        "coopVector_ArithmeticOp",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::ArgMemOnly,
    ...
    // udt,   obj ,  function attribute
    {
        OC::CoopVector_LoadRawBuf,
        "CoopVector_LoadRawBuf",
        OCC::CoopVector_LoadRawBuf,
        "coopVector_LoadRawBuf",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_LoadGroupShared,
        "CoopVector_LoadGroupShared",
        OCC::CoopVector_LoadGroupShared,
        "coopVector_LoadGroupShared",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_StoreRawBuf,
        "CoopVector_StoreRawBuf",
        OCC::CoopVector_StoreRawBuf,
        "coopVector_StoreRawBuf",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_StoreGroupShared,
        "CoopVector_StoreGroupShared",
        OCC::CoopVector_StoreGroupShared,
        "coopVector_StoreGroupShared",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_MatMul,
        "CoopVector_MatMul",
        OCC::CoopVector_MatMul,
        "coopVector_MatMul",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_MatMulAdd,
        "CoopVector_MatMulAdd",
        OCC::CoopVector_MatMulAdd,
        "coopVector_MatMulAdd",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_CopyFrom,
        "CoopVector_CopyFrom",
        OCC::CoopVector_CopyFrom,
        "coopVector_CopyFrom",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_ScalarMulAdd,
        "CoopVector_ScalarMulAdd",
        OCC::CoopVector_ScalarMulAdd,
        "coopVector_ScalarMulAdd",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_ScalarMin,
        "CoopVector_ScalarMin",
        OCC::CoopVector_ScalarMin,
        "coopVector_ScalarMin",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_ScalarMax,
        "CoopVector_ScalarMax",
        OCC::CoopVector_ScalarMax,
        "coopVector_ScalarMax",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    ...
    {
        OC::CoopVector_ReadFromIndex,
        "CoopVector_ReadFromIndex",
        OCC::CoopVector_ReadFromIndex,
        "coopVector_ReadFromIndex",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_WriteToIndex,
        "CoopVector_WriteToIndex",
        OCC::CoopVector_WriteToIndex,
        "coopVector_WriteToIndex",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    {
        OC::CoopVector_Activation,
        "CoopVector_Activation",
        OCC::CoopVector_Activation,
        "coopVector_Activation",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::ArgMemOnly,
    },
    ...
    //                                                                                                                         void,     h,     f,     d,    i1,    i8,   i16,   i32,   i64,   udt,   obj ,  function attribute
    {
        OC::CoopVector_ScalarClamp,
        "CoopVector_ScalarClamp",
        OCC::CoopVector_ScalarClamp,
        "coopVector_ScalarClamp",
        {false, true, true, true, false, true, true, true, false, false, false},
        Attribute::None,
    },
    ...
    // udt,   obj ,  function attribute
    {
        OC::CoopVector_BitwiseOp,
        "CoopVector_BitwiseOp",
        OCC::CoopVector_BitwiseOp,
        "coopVector_BitwiseOp",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::ArgMemOnly,
    ...
    //                                                                                                                         void,     h,     f,     d,    i1,    i8,   i16,   i32,   i64,   udt,   obj ,  function attribute
    {
        OC::CoopVector_ScalarBitwiseOp,
        "CoopVector_ScalarBitwiseOp",
        OCC::CoopVector_ScalarBitwiseOp,
        "coopVector_ScalarBitwiseOp",
    ...
    // udt,   obj ,  function attribute
    {
        OC::CoopVector_BitwiseShift,
        "CoopVector_BitwiseShift",
        OCC::CoopVector_BitwiseShift,
        "coopVector_BitwiseShift",
        {false, false, false, false, false, true, true, true, true, false,
         false},
        Attribute::ArgMemOnly,
    ...
    {
        OC::CoopVector_Negate,
        "CoopVector_Negate",
        OCC::CoopVector_Negate,
        "coopVector_Negate",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::ArgMemOnly,
    ...
    {
        OC::CoopVector_OuterProductAccumulate,
        "CoopVector_OuterProductAccumulate",
        OCC::CoopVector_OuterProductAccumulate,
        "coopVector_OuterProductAccumulate",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
    ...
    {
        OC::CoopVector_ReduceSumAccumulate,
        "CoopVector_ReduceSumAccumulate",
        OCC::CoopVector_ReduceSumAccumulate,
        "coopVector_ReduceSumAccumulate",
        {true, false, false, false, false, false, false, false, false, false,
         false},
        Attribute::None,
...
void OP::GetMinShaderModelAndMask(OpCode C, bool bWithTranslation,
  ...
  if (op == 245 || op == 254 || (258 <= op && op <= 261) ||
      (263 <= op && op <= 278) || op == 280 || (282 <= op && op <= 285)) {
    major = 6;
    minor = 8;
    return;
  }
...
Function *OP::GetOpFunc(OpCode opCode, Type *pOverloadType) {
  ...
  Type *pCoopVector = GetCoopVecPtrType();
  Type *pCoopVectorProps = GetCoopVecPropertiesType();
...
#define VEC4(_y) A(GetVectorType(4, _y))
  ...
  case OpCode::CoopVector_CopyFrom:
    ...
    A(pCoopVector);
    break;
  case OpCode::CoopVector_ScalarMulAdd:
    A(pV);
    A(pI32);
    A(pCoopVector);
    A(pETy);
  ...
  case OpCode::CoopVector_ScalarMax:
    ...
    A(pETy);
    break;
  case OpCode::CoopVector_Min:
    A(pV);
    A(pI32);
    A(pCoopVector);
    A(pCoopVector);
    break;
  case OpCode::CoopVector_Max:
    A(pV);
    A(pI32);
    A(pCoopVector);
    A(pCoopVector);
    break;
  case OpCode::CoopVector_ReadFromIndex:
    A(pETy);
    A(pI32);
    A(pCoopVector);
    A(pI32);
...
StructType *OP::GetCoopVecPropertiesType() const {
  return m_pCoopVectorPropsType;
}

PointerType *OP::GetCoopVecPtrType() const { return m_pCoopVectorType; }
