...
enum class OpCode : unsigned {
  ...
  CoopVector_ScalarBitwiseOp = 281, // Perform Scalar bitwise operation on each
                                    // element of Cooperative Vector
  CoopVector_ScalarClamp = 279,     // Perform scalar clamp operation on each
                                    // element of Cooperative Vector
  ...
  CoopVector_Activation =
      277, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_Annotate =
      259, // Annotate a wave matrix pointer with the type information
  CoopVector_BitwiseOp =
      280, // Perform bitwise operation on each element of Cooperative Vector
  CoopVector_BitwiseShift =
      282, // Shift left each integer vector by given num of bits
  CoopVector_Clamp =
      278, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_CopyFrom =
      269, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_Fill = 260, // Fill coopvector with scalar value
  CoopVector_Index =
      258, // Returns the element in an Coop Vector at specified index
  CoopVector_LoadGroupShared = 264, // Load wave matrix from group shared array
  ...
  CoopVector_ScalarMax =
      272, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_ScalarMin =
      271, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_ScalarMulAdd =
      270, // Perform scalar operation on each element of Cooperative Vector
  CoopVector_ScalarOp =
      261, // Perform scalar operation on each element of Cooperative Vector
  ...
  WaveMatrix_ScalarOp =
      235, // Perform clamp operation on each element of wave matrix
